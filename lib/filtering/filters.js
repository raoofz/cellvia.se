(() => {
  ...
  function filterProducts(products, { query = "", category = "", prisonId = "", status = "", packageTag = "", sourceCategory = "" }, compatibility) {
    return products.filter((product) => {
      ...
      return matchesText && matchesCategory && matchesPrison && matchesStatus && matchesPackage && matchesSource;
    });
  }
